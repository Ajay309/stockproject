...
export default function Navbar() {
  ...
  return (
    <nav className="navbar navbar-expand-lg position-fixed w-100 z-1  navbar-light bg-white shadow-sm py-1 px-3 px-lg-5" style={navbarOffsetStyle}>
      <Link className="navbar-brand fw-bold text-primary" to="/">  <img src="assets/logos/PNG-Logo.png" className='img-fluid' style={{ width: '100px' }} alt="Logo" />
</Link>
      <button
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        {/* Navigation Links */}
        <ul className="navbar-nav gap-2 mx-auto me-5">
        ...
        <div className="ms-auto d-none border-left d-lg-flex flex-column flex-lg-row justify-content-end gap-2 gap-lg-4 mt-3 mt-lg-0">
